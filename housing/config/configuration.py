...
class Configuration:
    def __init__(self,
        ...
        try:
            ...
            self.trianing_pipeline_config = self.get_training_pipline_config()
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            artifact_dir = self.trianing_pipeline_config.artifact_dir
...
#MODULAR PROGRAMMING
    ...
    def get_model_evaulation_config(self) -> ModelEvaluationConfig:
        try:
            model_evaluation_config = self.config_info[MODEL_EVALUATION_CONFIG_KEY]
            artifact_dir = os.path.join(self.trianing_pipeline_config.artifact_dir,
